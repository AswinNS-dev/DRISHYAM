import { $ as utcSundays, $n as stepBefore, $r as tau$4, $t as numberArray_default, A as utcMonth, An as max, Ar as area_default, At as sqrt, B as timeThursday, Bn as bisectCenter, Br as pathRound, Bt as format, C as utcTicks, Cn as quantileIndex, Cr as cross_default, Ct as milliseconds, D as utcYears, Dn as minIndex, Dr as bumpX, Dt as quantile$1, E as utcYear, En as quickselect, Er as bumpRadial, Et as quantize, F as timeMondays, Fn as compareDefined, Fr as array_default$2, Ft as tickFormat, G as timeWednesdays, Gn as ascending, Gr as cos$2, Gt as piecewise, H as timeTuesday, Hn as bisectRight, Hr as acos$1, Ht as locale_default, I as timeSaturday, In as sort, Ir as slice$3, It as precisionRound_default, J as utcMonday, Jn as expand_default, Jr as max$3, Jt as string_default, K as utcFriday, Kn as wiggle_default, Kt as round_default, L as timeSaturdays, Ln as permute, Lr as withPath, Lt as precisionPrefix_default, M as timeFriday, Mn as tickStep, Mr as x$2, Mt as log, N as timeFridays, Nn as ticks, Nr as y$2, Nt as identity, O as timeMonth, On as min, Or as bumpY, Ot as radial, P as timeMonday, Pn as ascendingDefined, Pr as linear_default, Pt as linear$1, Q as utcSunday, Qn as stepAfter, Qr as sqrt$2, Qt as array_default, R as timeSunday, Rn as InternMap, Rr as Path, Rt as precisionFixed_default, S as utcTickInterval, Sn as quantile, Sr as diamond_default, St as millisecond, T as timeYears, Tn as greatest, Tr as asterisk_default, Tt as threshold, U as timeTuesdays, Un as bisector, Ur as asin$1, Ut as FormatSpecifier, V as timeThursdays, Vn as bisectLeft, Vr as abs$3, Vt as formatPrefix, W as timeWednesday, Wn as descending, Wr as atan2$1, Wt as formatSpecifier, X as utcSaturday, Xn as none_default$1, Xr as pi$3, Xt as number_default, Y as utcMondays, Yn as stack_default, Yr as min$2, Yt as object_default, Z as utcSaturdays, Zn as none_default, Zr as sin$2, Zt as date_default, _ as utcFormat, _n as band, _r as star_default, _t as timeMinutes, a as divergingSymlog, an as basisClosed_default$1, ar as basisOpen_default, at as utcWednesdays, b as timeTickInterval, bn as ordinal, br as plus_default, bt as second, c as sequentialLog, cn as Rgb, cr as basis_default, ct as unixDay, d as sequentialSymlog, dn as darker, dr as symbolsFill, dt as utcDays, ei as constant_default$9, en as rgbBasis, er as step_default, et as utcThursday, f as utcTime, fn as hsl, fr as symbolsStroke, ft as timeHour, g as timeParse, gn as extend, gr as triangle_default, gt as timeMinute, h as timeFormat, hn as define_default, hr as triangle2_default, ht as utcHours, i as divergingSqrt, in as nogamma, ir as linearClosed_default, it as utcWednesday, j as utcMonths, jn as tickIncrement, jr as line_default, jt as symlog, k as timeMonths, kn as maxIndex, kr as pointRadial_default, kt as pow, l as sequentialPow, ln as brighter, lr as noop_default$1, lt as unixDays, m as defaultLocale$1, mn as rgbConvert, mr as wye_default, mt as utcHour, n as divergingLog, nn as rgb_default, nr as monotoneX, nt as utcTuesday, o as sequentialQuantile, on as basis_default$1, or as basisClosed_default, ot as timeDay, p as time, pn as rgb, pr as times_default, pt as timeHours, q as utcFridays, qn as silhouette_default, qr as halfPi$3, qt as value_default, r as divergingPow, rn as hue, rr as monotoneY, rt as utcTuesdays, s as sequential, sn as Color, sr as Basis, st as timeDays, t as diverging, tn as rgbBasisClosed, tr as natural_default, tt as utcThursdays, u as sequentialSqrt, un as color, ur as Symbol$1, ut as utcDay, v as utcParse, vn as point, vr as square2_default, vt as utcMinute, w as timeYear, wn as quantileSorted, wr as circle_default$2, wt as timeInterval, x as timeTicks, xn as range, xr as diamond2_default, xt as seconds, y as formatLocale, yn as implicit, yr as square_default, yt as utcMinutes, z as timeSundays, zn as InternSet, zr as path, zt as defaultLocale } from "./diverging-E7fmL8HY.js";
...
function identity_default$3(d) {
	return d;
}
//#endregion
//#region node_modules/d3-shape/src/pie.js
function pie_default() {
	var value = identity_default$3, sortValues = descending_default$1, sort = null, startAngle = constant_default$9(0), endAngle = constant_default$9(tau$4), padAngle = constant_default$9(0);
	function pie(data) {
...
function insideOut_default(series) {
	var n = series.length, i, j, sums = series.map(sum$2), order = appearance_default(series), top = 0, bottom = 0, tops = [], bottoms = [];
	for (i = 0; i < n; ++i) {
		j = order[i];
		if (top < bottom) {
			top += sums[j];
...
function axis(orient, scale) {
	...
	function axis(context) {
		var values = tickValues == null ? scale.ticks ? scale.ticks.apply(scale, tickArguments) : scale.domain() : tickValues, format = tickFormat == null ? scale.tickFormat ? scale.tickFormat.apply(scale, tickArguments) : identity_default$2 : tickFormat, spacing = Math.max(tickSizeInner, 0) + tickPadding, range = scale.range(), range0 = +range[0] + offset, range1 = +range[range.length - 1] + offset, position = (scale.bandwidth ? center : number)(scale.copy(), offset), selection = context.selection ? context.selection() : context, path = selection.selectAll(".domain").data([null]), tick = selection.selectAll(".tick").data(values, scale).order(), tickExit = tick.exit(), tickEnter = tick.enter().append("g").attr("class", "tick"), line = tick.select("line"), text = tick.select("text");
